const API_KEY = "740989379276d3d492dd77fadaef488b";
...
function setMainMovie(movie) {
  ...
  info.innerHTML = movie.release + " - " + movie.genre;
...
async function getMovieData(movieId) {
  ...
  if (isMovieInList === -1) {
    try {
      let data = await fetch(getMovie(movieId));
...
function loadMovies() {
  const LIST_MOVIES = ["tt14111726", "tt11671006", "tt0356150", "tt10127708"];
...
function formattedMovieId(movieId) {
  // https://www.imdb.com/title/tt0454987/
